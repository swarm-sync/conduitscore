        ...
        if (
          ...
          await sendEmail({
            ...
            html: `<div style="font-family:sans-serif;max-width:560px;margin:0 auto;padding:32px 24px;">
              ...
              <p style="margin-top:24px;"><a href="${process.env.NEXT_PUBLIC_SITE_URL?.trim() ?? "https://conduitscore.com"}/projects" style="display:inline-block;background:#6c3bff;color:#fff;text-decoration:none;padding:12px 20px;border-radius:8px;font-weight:600;">Open Projects</a></p>
            </div>`,
