...
## The One-Page Framework: 46 Signals in 7 Categories

The 46 AI visibility signals are organized into 7 categories. On a one-page checklist, they include:
...
**Upsell 1: Monthly monitoring.** The 46 signals can degrade. Offer monthly AI visibility rescans using paid plans as part of a retainer.
...
By adopting the 46-signal framework:
...
**Step 1: Understand the 46 signals.** Read them. Understand what each one measures. You do not need to be technical.

**Step 2: Pick one client.** Run a free scan at ConduitScore.com. See the framework in action. This takes 15 seconds.

**Step 3: Draft your audit template.** Create a one-page template that matches your brand. List 46 signals. Add your agency name and logo.
...
The 46-signal framework works for agencies because:
...
Most importantly, it is honest. You are not making up frameworks. The 46 signals are based on how AI systems actually work.

**Start with a free scan at ConduitScore.com.** See how the 46 signals show up on a real site. Then adapt this playbook to your clients and watch your win rate increase.

## CTA 1: Free Scan

Scan your own site first at ConduitScore.com to understand the 46 signals before auditing clients. Three free scans per month, no signup required.
