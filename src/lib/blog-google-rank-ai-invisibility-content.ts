/**
 * Markdown-style body for /blog/google-rank-ai-invisibility
 * Parsed by bracket splitting in blog/[slug]/page.tsx (headings, **bold**, etc.).
 */
export const BLOG_GOOGLE_RANK_AI_INVISIBILITY_CONTENT = `You rank first for your main keyword. The curve looks healthy. Good news.
